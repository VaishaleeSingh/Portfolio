  ...
  return (
    <FadeInSection id="about">
      ...
      <div className="about-content grid grid-cols-1 items-center gap-8 rounded-3xl p-6 sm:p-8 md:grid-cols-[minmax(220px,280px)_1fr] md:gap-10 lg:p-10">
        ...
        >
          <Image alt="Vaishalee Singh - Software Developer" src="/Vaishalee.jpeg" width={250} height={250} loading="lazy" className="h-full w-full rounded-full object-cover object-[50%_20%]" />
        </motion.div>
