...
export default function About() {
  return (
    <FadeInSection id="about">
      ...
      <div className="about-content grid grid-cols-1 items-center gap-6 rounded-2xl p-5 sm:gap-8 sm:rounded-3xl sm:p-8 md:grid-cols-[minmax(220px,280px)_1fr] md:gap-10 lg:p-10">
        <motion.div
